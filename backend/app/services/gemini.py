...
def build_extraction_prompt(columns: List[ColumnConfig], categories: List[CategoryConfig] = None, corrections: list = None, cost_categories: list = None) -> str:
    ...
    if cost_categories:
        ...
        fields_desc["cost_category"] = (
            ...
            "1. If vendor is Valard, WESTOWER, SC360, MACC4D, or Eion: ONLY Fiber Build or Make Ready (never Payroll, Material, or Electronics). "
            "   Hours/perdiem/travel/wages from these vendors = field labor for construction → Fiber Build. "
            "2. OLT/ONT/chassis/optical modules/transceivers → Electronics. "
